...
<body class="hold-transition login-page">
    <div class="login-box">
        ...
        <div class="login-box-body">
            <h4 class="login-box-msg">Cek Pin user</h4>
            ...
            ?>
            <form action="<?= base_url(); ?>/auth/cekPin" method="post">
                <input type="hidden" class="form-control" value=<?= $email; ?> name="email">
                <div class="form-group has-feedback">
                    <input type="password" class="form-control" placeholder="Insert Pin" name="pin">
                    <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
                </div>
                <div class="row">
                    <div class="col-xs-8">
                        <label>
                            kembali | <a href="<?= base_url('auth/index') ?>">Click here!</a>
                        </label>
                    </div>
                    <!-- /.col -->
                    <div class="col-xs-4">
