    ...
    <div class="col-md-12">
        <div class="box box-primary box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">Laporan instansi</h3>
                <!-- /.box-tools -->
            ...
            <div class="box-body">
                <div id="div1">
                    ...
                    <br>
                    <span>Jumlah data : <?= count($instansi); ?></span>
                    <br>
                    <br>
                    <br>
                    <center>
                        <table id="myTable" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" width="100px">Nama Instansi</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php $i = 1; ?>
                                <?php foreach ($instansi as $a) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><?= $a['nama_instansi']; ?></td>
                                    </tr>
                                    <?php $i++; ?>
                                <?php endforeach; ?>
                            </tbody>
